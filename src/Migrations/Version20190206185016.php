 ...
 */
final class Version20190206185016 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE alquiler (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, usuario_id INTEGER NOT NULL, departamento_id INTEGER NOT NULL, fecha_inicio DATE NOT NULL, cantidad_dias INTEGER NOT NULL, finalizado BOOLEAN DEFAULT NULL)');
